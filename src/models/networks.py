...
class NLayerDiscriminator(nn.Module):
    def __init__(self, input_nc, ndf=64, n_layers=3, norm_layer=nn.BatchNorm2d, use_sigmoid=False, gpu_ids=[]):
        ...
        sequence += [nn.Conv2d(ndf * nf_mult, ndf * nf_mult,
                               kernel_size=kw, stride=1, padding=padw)]
        sequence += [nn.Conv2d(ndf * nf_mult, 128,
...
#        if use_sigmoid:
      #  sequence += [nn.Sigmoid()]
        ...
        self.conv1 = nn.Conv2d(128, 1, kernel_size=4,
                               stride=1, padding=1, bias=True)

        # nn.Conv2d(128, 20, kernel_size=4, stride=1, padding=0, bias=True)
